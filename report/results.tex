...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of CDO depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of DDO depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of TFTR depending on the Noise} \label{tab:tftr}\vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of SSW depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of LCDO depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of LDDO depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of WAT depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of EVO depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{table}[h]
 \begin{center}
\caption{Cooperations of LTFT depending on the noise} \vspace{3mm}
\begin{tabular}{|l|c|c|c|c|c|}
\hline
   	& noise2 = 0 & noise2 = 0.05& noise2 = 0.1& noise2 = 0.15 \\
  \hline
...
\begin{minipage}[hbt]{1\textwidth}
	\centering
	\subfloat[Simulation 1]{\label{fig:simul1namedplayer}\includegraphics[width=\textwidth]{pics/simulation1/Reward_vs_Noise_with_best_Player_named}}
\end{minipage}

\begin{minipage}[hbt]{1\textwidth}
	\centering
	\subfloat[Simulation 2]{\label{fig:simul2namedplayer}\includegraphics[width=0.9\textwidth]{pics/simulation2/Reward_vs_Noise_with_best_Player_named}}
\end{minipage}	
\end{figure}
